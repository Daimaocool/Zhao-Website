(function () {
  const translations = {
    zh: {
      ...
      heroTitle: "赵宇轩",
      heroAlias: "赵宇轩 · YUXUAN ZHAO · Standley Zhao",
      heroSubtitle:
      ...
      profileBody:
        "我是赵宇轩，英文名 YUXUAN ZHAO，也使用 Standley Zhao 作为英文名。我在惟则信息技术（上海）有限公司工作三年，长期参与制造业 MES/EMS、ERP、AI 知识检索、人脸识别、数据中心 BMS/HMI 与能源管理系统建设，工作覆盖需求理解、模块开发、现场联调、数据采集、报表和可视化展示。",
      eduLabel: "教育背景",
      eduTitle: "重庆第二师范学院",
      ...
      contactKicker: "联系",
      contactTitle: "欢迎交流。",
      contactNames: "赵宇轩 · YUXUAN ZHAO · Standley Zhao",
    },
    en: {
      brand: "YUXUAN ZHAO",
      navProfile: "Profile",
    ...
    ja: {
      ...
      profileBody:
        "YUXUAN ZHAO（赵宇轩）、Standley Zhao としても表記しています。惟則信息技術（上海）有限公司で 3 年勤務し、製造業 MES/EMS、ERP、AI 知識検索、顔認識、データセンター BMS/HMI、エネルギー管理システムに関わりました。要件理解、モジュール開発、現場連携、データ収集、レポート、可視化まで担当しました。",
      eduLabel: "学歴",
      eduTitle: "重慶第二師範学院",
  ...
  const seo = {
    zh: {
      title: "赵宇轩 | YUXUAN ZHAO | Standley Zhao | 软件工程师",
      description:
        "赵宇轩，英文名 YUXUAN ZHAO，也使用 Standley Zhao，关注工业软件、MES、ERP、AI 知识检索、数据中心 BMS/HMI、OPC 数据采集和能源管理系统。",
      locale: "zh_CN",
      url: "https://zhao.hiyeup.com/zh/",
    },
    en: {
      title: "YUXUAN ZHAO | 赵宇轩 | Standley Zhao | Industrial Software Engineer",
      description:
        "YUXUAN ZHAO, also known as 赵宇轩 and Standley Zhao, is a software engineer focused on industrial software, MES, ERP, AI knowledge retrieval, data center BMS/HMI, OPC data acquisition, and energy management systems.",
      locale: "en_US",
      url: "https://zhao.hiyeup.com/",
    },
    ja: {
      title: "YUXUAN ZHAO | 赵宇轩 | Standley Zhao | ソフトウェアエンジニア",
      description:
        "YUXUAN ZHAO（赵宇轩、Standley Zhao）は、産業ソフトウェア、MES、ERP、AI 知識検索、データセンター BMS/HMI、OPC データ収集、エネルギー管理に取り組むソフトウェアエンジニアです。",
      locale: "ja_JP",
